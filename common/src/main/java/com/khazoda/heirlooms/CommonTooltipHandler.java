...
public class CommonTooltipHandler {
  ...
  public static void handleTooltip(ItemStack stack, List<Component> tooltip, TooltipFlag flag, boolean isCtrlPressed, boolean isAltPressed) {
    String craftedTimestamp = stack.get(HeirloomsMod.CRAFTED_TIMESTAMP);
    String craftedBy = stack.get(HeirloomsMod.CRAFTED_BY);
    String enchantedTimestamp = stack.get(HeirloomsMod.ENCHANTED_TIMESTAMP);
    String enchantedBy = stack.get(HeirloomsMod.ENCHANTED_BY);
